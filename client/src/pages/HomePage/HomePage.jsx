    ...
    return (
      ...
      <div className="Home">
        <div className="Home-slides">
          <div style={{ animationDelay: '0s' }}><img src={slideimage[0].src}/></div>
          <div style={{ animationDelay: '4s' }}><img src={slideimage[1].src}/></div>
          <div style={{ animationDelay: '8s' }}><img src={slideimage[2].src}/></div>
          <div style={{ animationDelay: '12s' }}><img src={slideimage[3].src}/></div>
        </div>
